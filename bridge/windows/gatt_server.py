"""Temporary Windows GATT server for legacy Presence Pair app builds."""
...
class GattPairingServer:
    ...
    def advertisement_status(self) -> str:
        """Return the current normalized advertising status."""
        return self._advertisement_status

    @property
    def advertisement_error(self) -> str:
        """Return the last WinRT advertising error."""
    ...
    async def _async_wait_until_advertising(self) -> None:
        """Wait for Windows to confirm that the service is on air."""
